...
import volumeActive from '../../assets/volume-active.png';
...
export default function Controls() {
  ...
  const onNextClick = () => {
    console.log('Clicked next track button...')
  ...
  return (
    <ControlsStyled>
      ...
      <svg className="controls-prev" onClick={onPrevClick} viewBox='0 0 25 25' width='20' height='20'>
        <Prev />
      </svg>
      <svg className="controls-play-pause" onClick={onPlayPauseClick} viewBox='0 0 25 25' width='30' height='30'>
        {
      ...
      <svg className="controls-next" onClick={onNextClick} viewBox='0 0 25 25' width='20' height='20'>
        <Next />
      </svg>
      <svg className="controls-hamburger" onClick={onQueueClick} viewBox='0 0 25 25' width='15' height='15'>
        <Hamburger />
      </svg>
    </ControlsStyled>
  )
